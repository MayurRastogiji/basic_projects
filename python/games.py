...
def rockpaperscissors(name, n):
    ...
    computer_score = 0
    while a <= n:
        user_input = int(input(speakandprint(
...
def tic_tac_toe_person(player1, player2):
    ...
    speakandprint(
        "The player who gets 3 marks in a row, column or diagonal wins the game.")
    speakandprint("Lets start the game.")
    choice_symbol_1 = input(speakandprint(
        f"{player1} Enter your choice of symbol (X or O) : "))
...
speakandprint(
    f"welcome {name} to the world of games. We have many games for you to play")
speakandprint("choose the game you want to play")
choice = 0
while True:
    choice = input(speakandprint(
    ...
    if choice == '1':
        ...
        choice_in = input(speakandprint(
            "Do you want to play with computer or with another player"))
