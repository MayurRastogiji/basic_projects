            ...
            while (!op.equals("exit")) {
                ...
                if (op.equals("exit")) {
                    ...
                    int result = switch (op) {
                        case "+", "add", "addition" -> obj.add(n1, n2);
                        case "-", "sub", "subtraction" -> obj.sub(n1, n2);
                        case "*", "multiply", "multiplication" -> obj.mul(n1, n2);
                        case "/", "divide", "division" -> obj.div(n1, n2);
                        case "%", "modulo", "modulus" -> obj.remainder(n1, n2);
                        case "^", "power", "exponential" -> obj.pow(n1, n2);
                        default ->{
